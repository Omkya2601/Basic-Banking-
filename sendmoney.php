...
<body>
    ...
    <div class="container">
        ...
        <img src="bank.png" height="55%" width="25%" alt="welcome to the sparks bank!" style="padding:5px;margin-right:8vw;margin-top:8vh;float:right">
        <br><br>
        <br><br>
    </div>
    <br><br>
            ...
            <div class="subcontent">
                ...
                <form action="sendmoney.php" method="POST">
                    ...
                    if($result->num_rows>0){
                        while($row=$result-> fetch_assoc()){
                            ...
                            echo "<option value=".$row["Account_no"].">".$row["Name"]."<p> &nbsp; &nbsp;</p>".$row["Account_no"]."</option>";
                           # echo "<option=".$row["Account_no"].">".$row["Name"]."<p> &nbsp; &nbsp;</p>".$row["Account_no"]."</option>";
                ...
                if(isset($_POST['sender'])){
                    ...
                    if($amount>$sender_bal){
                        ...
                        echo "<h3 style='color:red'>Transaction failed! Insufficent balance in Sender's Account</h3>";
