...
<body>
    ...
    <center>
        <div class="contentbox">
            <h1>ABOUT US</h1>
            <img src="developer.PNG" alt="Developer Profile" width="150px" height="20%" style="border-radius: 10px;border-style: double;display: block;margin: 5px;">
            <h4>This website is created by..</h4>
            <h2 >Omkar Jadhav</h2>
            <h4>Intern at Sparks Foundation<br>MIT ACSC College Alandi,Pune</h4>
        ...
        <div class="footer">
            <center>
               <h2 style="color:'orange'"> Made With love By Omkar!</h2>
            </center>
        </div>
</center>
</body>
